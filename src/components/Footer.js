...
import useFormContext from "./ResponsiveEvent.jsx/useFormContext"
...
export default function Footer() {
  const { title,   eventFormData, setEventFormData, canSubmit, handleSubmit ,setErrors,errors } = useFormContext()
