...
const PlannedFamilymember = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://localhost:44311/api/SiteVisitdetails/Visitcompletedfamilymemdetails'); 
  ...
  return (
    <div className="family-members-container">
      <h4>Planned visit by Family Members</h4>
...
export default PlannedFamilymember;
